...
**Relies on**: [LESSPHP 0.3.4-2](http://leafo.net/lessphp/), [plugin-toolkit](http://wordpress.org/extend/plugins/plugin-toolkit/).
 ...
 * lessphp: updated to 0.3.4-2 (compatible with lessjs 1.3)
